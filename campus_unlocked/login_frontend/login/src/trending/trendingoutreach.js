...
function TrendingPhotosoutreach() {
  ...
  return (
    <><div className="trending_location">Outreach Building</div><div className="slideshow-container">
      {allImage.length === 0 ?
...
export default TrendingPhotosoutreach;
