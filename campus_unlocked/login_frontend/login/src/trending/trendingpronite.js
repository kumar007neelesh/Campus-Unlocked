...
function TrendingPhotospronite() {
  ...
  return (
    <><div className="trending_location">Pronite Ground</div><div className="slideshow-container">
      {allImage.length === 0 ?
...
export default TrendingPhotospronite;
